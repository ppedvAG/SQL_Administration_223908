--sp_help_revlogin --Ausgabefenster

IF NOT EXISTS (SELECT * FROM sys.server_principals WHERE name = N'Peter2')
                  BEGIN
CREATE LOGIN [Peter2] WITH PASSWORD = 0x0200B607E9CA5CF1F9535D248C1426DD28CC8B49C0FADF29B506A4948645573A7024738C681113799325B79B8F14A4034E9919219352521344191485C5C7C433259CCA600ECD HASHED, 
SID = 0x50B35BE7F11B064A9FD833865805E8F4, 
DEFAULT_DATABASE = [Northwind], DEFAULT_LANGUAGE = [Deutsch], CHECK_POLICY = OFF, CHECK_EXPIRATION = OFF
